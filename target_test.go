...
func TestParsePath(t *testing.T) {
	tests := []struct {
		...
		{"scheme uppercase accepted", "/HTTPS/example.com", PathTarget{"https", "example.com", 0, "/", ModePure}, "", ""},

		// --- Scheme-segment mode suffix ({plain, +retry, +pure} x {http, https}) ---
		{"mode retry https", "/https+retry/example.com/x", PathTarget{"https", "example.com", 0, "/x", ModeRetry}, "", ""},
		{"mode retry http with port", "/http+retry/h.dev:4000/v1/x", PathTarget{"http", "h.dev", 4000, "/v1/x", ModeRetry}, "", ""},
		{"mode pure https", "/https+pure/example.com/x", PathTarget{"https", "example.com", 0, "/x", ModePure}, "", ""},
		{"mode pure http with port", "/http+pure/h.dev:4000/v1/x", PathTarget{"http", "h.dev", 4000, "/v1/x", ModePure}, "", ""},
		{"mode suffix case insensitive", "/HTTPS+RETRY/example.com", PathTarget{"https", "example.com", 0, "/", ModeRetry}, "", ""},
		{"mode mixed case pure", "/Https+Pure/example.com", PathTarget{"https", "example.com", 0, "/", ModePure}, "", ""},
		{"mode mixed case retry over lowercase scheme", "/HTTP+Retry/example.com", PathTarget{"http", "example.com", 0, "/", ModeRetry}, "", ""},
		{"mode retry empty path normalizes", "/https+retry/example.com", PathTarget{"https", "example.com", 0, "/", ModeRetry}, "", ""},
		{"mode pure empty path normalizes", "/https+pure/example.com", PathTarget{"https", "example.com", 0, "/", ModePure}, "", ""},
		...
		{"mode retry with ipv6", "/https+retry/[2001:db8::1]/x", PathTarget{"https", "2001:db8::1", 0, "/x", ModeRetry}, "", ""},
		{"mode pure with ipv6 and port", "/http+pure/[::1]:8080/x", PathTarget{"http", "::1", 8080, "/x", ModePure}, "", ""},
		{"mode retry raw path preserved", "/https+retry/h/a%2Fb%20c+d", PathTarget{"https", "h", 0, "/a%2Fb%20c+d", ModeRetry}, "", ""},
		{"mode pure raw path preserved", "/https+pure/h/a%2Fb%20c+d", PathTarget{"https", "h", 0, "/a%2Fb%20c+d", ModePure}, "", ""},
		{"plus in raw path not a mode", "/https/h/a+b+c", PathTarget{"https", "h", 0, "/a+b+c", ModePure}, "", ""},
		...
		// --- Valid simple targets (plain scheme segment: pure mode, same as +pure) ---
		{"https with path", "/https/api.example.com/v1/chat", PathTarget{"https", "api.example.com", 0, "/v1/chat", ModePure}, "", ""},
		{"http with path", "/http/h.dev:4000/v1/x", PathTarget{"http", "h.dev", 4000, "/v1/x", ModePure}, "", ""},
		{"empty path normalizes", "/https/example.com", PathTarget{"https", "example.com", 0, "/", ModePure}, "", ""},
		{"trailing slash equals root", "/https/example.com/", PathTarget{"https", "example.com", 0, "/", ModePure}, "", ""},
		{"scheme case insensitive", "/HTTP/example.com", PathTarget{"http", "example.com", 0, "/", ModePure}, "", ""},
		{"deep path preserved", "/https/h/a/b/c/d", PathTarget{"https", "h", 0, "/a/b/c/d", ModePure}, "", ""},
		{"empty segment in path preserved", "/https/h/a//b", PathTarget{"https", "h", 0, "/a//b", ModePure}, "", ""},
		{"path with colon", "/https/h/a:b", PathTarget{"https", "h", 0, "/a:b", ModePure}, "", ""},
		{"path with at-sign", "/https/h/x@y", PathTarget{"https", "h", 0, "/x@y", ModePure}, "", ""},
		{"encoded bytes preserved", "/https/h/a%2Fb%20c+d", PathTarget{"https", "h", 0, "/a%2Fb%20c+d", ModePure}, "", ""},
		{"percent in path preserved", "/https/h/%zz", PathTarget{"https", "h", 0, "/%zz", ModePure}, "", ""},

		// --- Ports ---
		{"explicit https port", "/https/h:8443/x", PathTarget{"https", "h", 8443, "/x", ModePure}, "", ""},
		{"port one", "/https/h:1", PathTarget{"https", "h", 1, "/", ModePure}, "", ""},
		{"port max", "/https/h:65535", PathTarget{"https", "h", 65535, "/", ModePure}, "", ""},
		...
		{"userinfo in path not authority", "/https/h/u@v", PathTarget{"https", "h", 0, "/u@v", ModePure}, "", ""},

		// --- IPv4 ---
		{"ipv4 literal", "/http/127.0.0.1:8080/x", PathTarget{"http", "127.0.0.1", 8080, "/x", ModePure}, "", ""},
		{"ipv4 default port", "/http/203.0.113.7", PathTarget{"http", "203.0.113.7", 0, "/", ModePure}, "", ""},
		...
		{"ipv6 loopback", "/https/[::1]:8443/x", PathTarget{"https", "::1", 8443, "/x", ModePure}, "", ""},
		{"ipv6 no port", "/https/[2001:db8::1]/x", PathTarget{"https", "2001:db8::1", 0, "/x", ModePure}, "", ""},
		{"ipv6 full", "/http/[::ffff:192.0.2.1]:80/x", PathTarget{"http", "::ffff:192.0.2.1", 80, "/x", ModePure}, "", ""},
		...
		// --- Host shapes ---
		{"dns single label", "/https/localhost", PathTarget{"https", "localhost", 0, "/", ModePure}, "", ""},
		{"dns multi label", "/https/a.b.example.com", PathTarget{"https", "a.b.example.com", 0, "/", ModePure}, "", ""},
		{"dns with digits", "/https/h1.example.com", PathTarget{"https", "h1.example.com", 0, "/", ModePure}, "", ""},
		{"dns internal hyphen", "/https/my-host.example.com", PathTarget{"https", "my-host.example.com", 0, "/", ModePure}, "", ""},
...
func TestPathTargetNormalizeAndRendering(t *testing.T) {
	tests := []struct {
		...
		{"http default", PathTarget{"http", "h", 0, "/", ModePure}, 80, "h:80", "http://h:80/"},
		{"https default", PathTarget{"https", "h", 0, "/", ModePure}, 443, "h:443", "https://h:443/"},
		{"explicit kept", PathTarget{"https", "h", 8443, "/x", ModePure}, 8443, "h:8443", "https://h:8443/x"},
		{"ipv6 bracketed in hostport", PathTarget{"https", "::1", 0, "/", ModePure}, 443, "[::1]:443", "https://[::1]:443/"},
		{"root path elided in url", PathTarget{"https", "h", 0, "/", ModePure}, 443, "h:443", "https://h:443/"},
		{"raw path preserved in url", PathTarget{"https", "h", 0, "/a%2Fb", ModePure}, 443, "h:443", "https://h:443/a%2Fb"},
		// Mode is orthogonal to destination rendering: HostPort/URL/Normalize
		// behave identically for +pure and +retry targets.
		{"mode pure default port", PathTarget{"https", "h", 0, "/", ModePure}, 443, "h:443", "https://h:443/"},
		{"mode retry explicit kept", PathTarget{"http", "h", 8080, "/x", ModeRetry}, 8080, "h:8080", "http://h:8080/x"},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			n := tt.in.Normalize()
